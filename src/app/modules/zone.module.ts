...
export default class Zone {
    ...
    public zone: any = {
        ...
        '湖北': ['武汉市', '黄石市', '十堰市', '宜昌市', '襄樊市', '鄂州市', '荆门市', '孝感市', '荆州市', '黄冈市', '咸宁市', '随州市', '恩施', '仙桃市', '潜江市', '天门市', '神农架林区'],
        ...
        '海南': ['海口市', '三亚市', '五指山市', '琼海市', '儋州市', '文昌市', '万宁市', '东方市', '定安县', '屯昌县', '澄迈县', '临高县', '白沙', '昌江', '乐东', '陵水', '保亭', '琼中', '西沙群岛', '南沙群岛', '中沙群岛'],
        '重庆': ['重庆市'],
        '四川': ['成都市', '自贡市', '攀枝花市', '泸州市', '德阳市', '绵阳市', '广元市', '遂宁市', '内江市', '乐山市', '南充市', '眉山市', '宜宾市', '广安市', '达州市', '雅安市', '巴中市', '资阳市', '阿坝', '甘孜', '凉山'],
        '贵州': ['贵阳市', '六盘水市', '遵义市', '安顺市', '铜仁', '黔西南', '毕节', '黔东南', '黔南'],
        '云南': ['昆明市', '曲靖市', '玉溪市', '保山市', '昭通市', '丽江市', '思茅市', '临沧市', '楚雄', '红河哈尼族', '文山', '西双版纳', '大理', '德宏', '怒江', '迪庆'],
        ...
        '青海': ['西宁市', '海东', '海北', '黄南', '海南', '果洛', '玉树', '海西'],
        '宁夏': ['银川市', '石嘴山市', '吴忠市', '固原市', '中卫市'],
        '新疆': ['乌鲁木齐市', '克拉玛依市', '吐鲁番', '哈密', '昌吉', '博尔塔拉', '巴音郭楞', '阿克苏', '克孜勒苏', '喀什', '和田', '伊犁哈萨克', '塔城', '阿勒泰', '石河子市', '阿拉尔市', '图木舒克市', '五家渠市'],
        '台湾': ['台湾'],
        '澳门': ['澳门'],
        '香港': ['香港'],
        '国外': ['国外']
    ...
    getAllProvince(): Array<string> {
      //console.log(Object.keys(this.zone))
      return Object.keys(this.zone);
    }

    getCityByProvince(province: string): Array<string> {
      return this.zone[province];
    }
}